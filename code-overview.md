      .maincontent { overflow:hidden; }   Apache ActiveMQ ™ -- Code Overview 

[ActiveMQ](http://activemq.apache.org "The most popular and powerful open source Message Broker") [ASF](http://www.apache.org "The Apache Software Foundation")

[Developers](developers.html) > [Code Overview](code-overview.html)
...
To see an overview of these packages try the [JavaDocs](javadocs.html)
...
[Privacy Policy](http://activemq.apache.org/privacy-policy.html) \- ([edit this page](https://cwiki.apache.org/confluence/pages/editpage.action?pageId=35934))
