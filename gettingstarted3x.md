      .maincontent { overflow:hidden; }   Apache ActiveMQ ™ -- Getting+Started+3.x 

[ActiveMQ](http://activemq.apache.org "The most popular and powerful open source Message Broker") ™ [ASF](http://www.apache.org "The Apache Software Foundation")

[Using ActiveMQ](using-activemq.html) > [Getting Started](getting-started.html) > [Getting+Started+3.x](gettingstarted3x.html)
...
[Privacy Policy](http://activemq.apache.org/privacy-policy.html) \- ([edit this page](https://cwiki.apache.org/confluence/pages/editpage.action?pageId=47236))
